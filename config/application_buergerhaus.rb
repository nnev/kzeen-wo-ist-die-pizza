...
module KzeenWoIstDiePizza
  class Application < Rails::Application
    ...
    config.x.pdf.street  = 'Schlierbacher Landstraße 130'
    config.x.pdf.city    = '69118 Heidelberg'
    config.x.pdf.phone   = '015792307561'
    config.x.pdf.email   = 'pizza@noname-ev.de'
    config.x.pdf.text    = 'ACHTUNG! Andere Adresse !!!'
    config.x.pdf.text2   = 'Kartons bitte beschriften'
    config.x.pdf.text3    = 'ACHTUNG! Andere Adresse !!!'
  end
end
